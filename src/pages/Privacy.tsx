    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-stone max-w-none text-gray-700 space-y-8">
        ...
        <section>
          ...
          <p className="mb-4">
            Your data is utilized solely to provide the core functionality of Jumbl: curating your books, projecting analytics like total pages read and heatmaps, and sending timezone-aware scheduled local notifications. We NEVER sell your data.
          </p>
        </section>
      </div>
    </div>
